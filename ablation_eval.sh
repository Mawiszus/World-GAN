...
do
    ...
    echo "$area"
    sbatch slurm_cpu.sh python experiment_entropy.py --folder "$d/files/random_samples/torch_blockdata" --not_cuda --input_dir ../minecraft_worlds/ --input_name "Drehmal v2.1 PRIMORDIAL" --input_area_name "$area"
