...
if __name__ == '__main__':
    ...
    use_bdata = False
    is_repr = False
    # pth = "/home/awiszus/Project/World-GAN/output/wandb/run-20210910_145403-85rt28qi/files/" \
    #       "arbitrary_random_samples_v1.00000_h1.00000_d1.00000/"
    pth = "/home/awiszus/Project/World-GAN/output/wandb/run-20210910_131137-233aerhz/files/" \
          "arbitrary_random_samples_v1.00000_h1.00000_d1.00000/"
    # name = "real_bdata_sc2.pt"
    name = "0_sc2.pt"
    token_list = torch.load(pth + "token_list.pt")
    used_tok_list = ["minecraft:air"]
    ...
    if use_bdata:
        ...
        if is_repr:
            ...
            block2repr = load_pkl("natural_representations_small",
                                  f"/home/awiszus/Project/World-GAN/input/minecraft/desert/")
            ...
            to_show = tensor[0, inds[0]].cpu().numpy().transpose([2, 0, 1])
            to_show = to_show - to_show.min()
            # cutoff = 0.7 * to_show.max()
